package com.iwenchaos.koteye.service;
...
public class QuickResultService extends DefaultTinkerResultService {
    private static final String TAG = "Tinker.QuickResultService";


    @Override
    public void onPatchResult(final PatchResult result) {
        if (result == null) {
            TinkerLog.e(TAG, "QuickResultService received null result!!!!");
            return;
        }
        TinkerLog.i(TAG, "QuickResultService receive result: %s", result.toString());
...
//                    QuickApplication.getInstance().restartApp();
                } else {
